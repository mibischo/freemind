...
public class MindIcon implements Comparable, IconInformation {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((associatedIcon == null) ? 0 : associatedIcon.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MindIcon other = (MindIcon) obj;
		if (associatedIcon == null) {
			if (other.associatedIcon != null)
				return false;
		} else if (!associatedIcon.equals(other.associatedIcon))
			return false;
		if (component == null) {
